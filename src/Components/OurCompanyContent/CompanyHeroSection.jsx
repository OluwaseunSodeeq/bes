...
function CompanyHeroSection() {
  ...
  return (
    <div className={styles.ourComapanyH}>
            ...
            <div className={styles.heading}>
              ...
              <div className={styles.headingContent}>
                ...
                <p>
                  ...
                  Get to Know Bortarr Engineering Service Better in this
                  Section.
                </p>
              </div>
            </div>
          ...
          <div className={styles.bottomUp}>
            <div className={styles.leftUp}>
              ...
              <p>
                ...
                engineering company with experience and expertise in the areas
                of Civil, Structural, Geotechnical, Marine Engineering, Harbour
                and Dredging Services Project Management and General
                Construction activities. The firm is well experienced and
                adequately equipped with the right machinery in all her areas of
                operation.
              </p>
            </div>
